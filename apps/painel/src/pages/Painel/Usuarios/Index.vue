<template>
	<div>
		...
		<q-form class="column q-gutter-sm no-wrap q-pa-sm" @submit.prevent="buscarUsuarios()">
			<div>
			...
			<div>
				<q-table
					...
					{ label: 'Perfis', align: 'left', name: 'companies', field: (item) => item.roles.map((role: any) => role.name).join(', '), style: 'width: 20%' },
				]"
					wrap-cells
